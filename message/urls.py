...
urlpatterns = [
	...
	path('message/<int:pk>/<int:a_pk>/',AnnouncementDetailView.as_view(), name='message-details'),
	path('message/<int:pk>/<int:a_pk>/update', AnnouncementUpdateView.as_view(), name='message-update'),
	path('message/<int:pk>/<int:a_pk>/delete', AnnouncementDeleteView.as_view(), name='message-delete'),
	path('workspace/new/', WorkspaceCreateView.as_view(), name='create-workspace'),
	path('message/<int:pk>/update', WorkspaceUpdateView.as_view(), name='workspace-update'),
